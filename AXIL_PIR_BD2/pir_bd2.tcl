...
proc create_root_design { parentCell } {
  ...
  set pir [ create_bd_port -dir I pir ]
  set sw0 [ create_bd_port -dir I sw0 ]

  # Create instance: axil_pir_0, and set properties
  set axil_pir_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axil_pir:1.0 axil_pir_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph1_M00_AXI [get_bd_intf_pins axil_pir_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph1/M00_AXI]

  # Create port connections
  connect_bd_net -net axil_pir_0_leds [get_bd_ports leds] [get_bd_pins axil_pir_0/leds]
  connect_bd_net -net pir_0_1 [get_bd_ports pir] [get_bd_pins axil_pir_0/pir]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins axil_pir_0/S_AXI_ACLK] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph1/ACLK] [get_bd_pins ps7_0_axi_periph1/M00_ACLK] [get_bd_pins ps7_0_axi_periph1/S00_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins axil_pir_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net sw0_0_1 [get_bd_ports sw0] [get_bd_pins axil_pir_0/sw0]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axil_pir_0/S_AXI/reg0] -force
