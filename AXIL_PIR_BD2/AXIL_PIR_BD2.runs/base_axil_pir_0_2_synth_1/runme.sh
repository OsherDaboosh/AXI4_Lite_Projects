...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIL_PIR_BD2/AXIL_PIR_BD2.runs/base_axil_pir_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axil_pir_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axil_pir_0_2.tcl
