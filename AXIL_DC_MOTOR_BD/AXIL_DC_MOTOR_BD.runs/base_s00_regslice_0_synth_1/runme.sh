...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIL_DC_MOTOR_BD/AXIL_DC_MOTOR_BD.runs/base_s00_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_s00_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_s00_regslice_0.tcl
