...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:axil_dc_motor_control:1.0\
...
proc create_root_design { parentCell } {
  ...
  set sw_out [ create_bd_port -dir O -from 1 -to 0 sw_out ]

  # Create instance: axil_dc_motor_control_0, and set properties
  set axil_dc_motor_control_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axil_dc_motor_control:1.0 axil_dc_motor_control_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph1_M00_AXI [get_bd_intf_pins axil_dc_motor_control_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph1/M00_AXI]

  # Create port connections
  connect_bd_net -net axil_dc_motor_control_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins axil_dc_motor_control_0/pwm_out]
  connect_bd_net -net axil_dc_motor_control_0_sw_out [get_bd_ports sw_out] [get_bd_pins axil_dc_motor_control_0/sw_out]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins axil_dc_motor_control_0/S_AXI_ACLK] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph1/ACLK] [get_bd_pins ps7_0_axi_periph1/M00_ACLK] [get_bd_pins ps7_0_axi_periph1/S00_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  connect_bd_net -net ps7_0_FCLK_RESET0_N [get_bd_pins ps7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_fclk0/ext_reset_in]
  connect_bd_net -net rst_ps7_0_fclk0_interconnect_aresetn [get_bd_pins ps7_0_axi_periph1/ARESETN] [get_bd_pins rst_ps7_0_fclk0/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins axil_dc_motor_control_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net sw_in_0_1 [get_bd_ports sw_in] [get_bd_pins axil_dc_motor_control_0/sw_in]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axil_dc_motor_control_0/S_AXI/reg0] -force
