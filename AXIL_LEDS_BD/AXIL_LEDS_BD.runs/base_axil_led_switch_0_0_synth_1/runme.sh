...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIL_LEDS_BD/AXIL_LEDS_BD.runs/base_axil_led_switch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axil_led_switch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axil_led_switch_0_0.tcl
