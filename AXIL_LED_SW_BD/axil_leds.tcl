...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:axi_led_switch:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_led_switch_0, and set properties
  set axi_led_switch_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_led_switch:1.0 axi_led_switch_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph1_M00_AXI [get_bd_intf_pins axi_led_switch_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph1/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_led_switch_0_led [get_bd_ports led] [get_bd_pins axi_led_switch_0/led]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins axi_led_switch_0/S_AXI_ACLK] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph1/ACLK] [get_bd_pins ps7_0_axi_periph1/M00_ACLK] [get_bd_pins ps7_0_axi_periph1/S00_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins axi_led_switch_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph1/M00_ARESETN] [get_bd_pins ps7_0_axi_periph1/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net sw_0_1 [get_bd_ports sw] [get_bd_pins axi_led_switch_0/sw]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axi_led_switch_0/S_AXI/reg0] -force
