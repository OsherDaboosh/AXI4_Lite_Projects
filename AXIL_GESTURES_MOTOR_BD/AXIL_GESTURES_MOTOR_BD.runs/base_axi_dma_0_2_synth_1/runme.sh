...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIL_GESTURES_MOTOR_BD/AXIL_GESTURES_MOTOR_BD.runs/base_axi_dma_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_dma_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_dma_0_2.tcl
