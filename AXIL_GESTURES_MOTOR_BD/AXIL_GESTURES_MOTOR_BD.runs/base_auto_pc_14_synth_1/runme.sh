...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIL_GESTURES_MOTOR_BD/AXIL_GESTURES_MOTOR_BD.runs/base_auto_pc_14_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_auto_pc_14.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_auto_pc_14.tcl
